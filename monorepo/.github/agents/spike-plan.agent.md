...
- Never produce code in spike output
- Reference codebase patterns, not create new ones
- All research must be verifiable
- CVE check required for new dependencies
- Keep spike scoped to knowledge acquisition
