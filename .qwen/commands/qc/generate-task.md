...
- Miss/refresh → try MCP → save → `view_image`. MCP unavailable → load `.qwen/skills/figma-design-context/SKILL.md` → save → `view_image`.
...
- **A** — Load `.qwen/skills/jira-ticket/SKILL.md`. For each task file:
