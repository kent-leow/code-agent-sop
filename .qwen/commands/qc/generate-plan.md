...
- **Miss/refresh**: (1) MCP: `get_design_context` + `get_screenshot` → save. (2) MCP unavailable → load `.qwen/skills/figma-design-context/SKILL.md` → execute all steps → save.
...
- **A** — Load `.qwen/skills/jira-ticket/SKILL.md`. Read `jira.json` first.
